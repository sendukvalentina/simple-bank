    ...
    <Container>
      <Tabs>
          ...
          <Form onSubmit={submitTransferHandler} className="mt-3">
            <Form.Group as={Row} controlId="formPlaintextRecepient">
              ...
              <Col sm="10">
                <Form.Control
                  type="account"
                  placeholder="Input the Recipient Account Number "
        ...
        <TabPanel>
          ...
          <div className="mb-5">
            <h6>Nomor Rekening : {saldoTotal != null && saldoTotal.account? saldoTotal.account.saldo : 0}</h6>
            <h6>Nama : {saldoTotal != null && saldoTotal.account ? saldoTotal.account.saldo : 0}</h6>
            <h6>Mata Uang : IDR</h6>
          </div>
          <table width="1200px">
            <th width="200px">Waktu</th><th width="400px">Keterangan</th><th width="300px">Mutasi</th><th width="300px">Saldo</th>
